...
public class ChooseTargetLogicTest {
    ...
    void TestChooseNearestTarget() {
        ...
        final var building1 = buildingsFactory.createCannon(new VectorInt2D(1, 2));
        final var building2 = buildingsFactory.createCannon(new VectorInt2D(1, 3));
        final var building3 = buildingsFactory.createCannon(new VectorInt2D(2, 1));
